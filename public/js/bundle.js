...
function popularProductsResponseModal(params) {
    var title = params.title || 'Спасибо за ваш заказ',
        subtitle = params.subtitle || 'мы скоро с вами свяжемся',
        // content = params.content,
        content = '',
...
function PopularProductsModal(params) {
    var container = params.container,
        $body = '',
        price = params.price,
    ...
    function render() {
        $(container).find('.iziModal-content').remove();
        $body = $('<div/>', {id: 'modal', class: 'skit__iziModal person-modal'}).append(
            $('<form/>', {class: 'popularProductsOrder'}).append(
                $('<div/>', {class: 'container-fluid'}).append(
                    $('<div/>', {class: 'row'}).append(
                        addField({
                            className: 'col-sm-12',
            ...
            .appendTo(container);
        $body.on('submit', '.popularProductsOrder', function () {
            $body.iziModal('close');
            $('body').trigger('popularProductClosed', self.getData());
            return false;
        });
        $body.iziModal({
            //autoOpen: true,
    ...
    this.getData = function () {
        return {
            ...
            phone: $body.find('[name="phone"]').val(),
            email: $body.find('[name="email"]').val(),
            price: $body.find('[price="price"]').val()
        }
    };
