        ...
        <div class="container vnl__container">
          ...
          <div class="d-none d-lg-block w-100">
            <ul class="navbar-nav w-100">
              ...
              <li class="nav-item col p-0">
                <a href="../gallery/gallery__cakes.html" class="btn btn-primary p-0 w-100">
          ...
          <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
            <ul class="navbar-nav w-100">
              ...
              <li class="d-block d-lg-none nav-item">
                <a class="btn btn-primary p-0 w-100 text-left" href="../gallery/gallery__cakes.html">
                  <h3>Галлерея тортов</h3>
                </a>
              </li>
      
              <li class="nav-item col-lg p-0">
                <a href="../gallery/gallery__dessert.html" class="btn btn-primary p-0 w-100 text-left text-lg-center">
        ...
        <div class="accordion" id="faq__accordion">
          ...
          <div class="product-review">
            ...
            <div id="faq__collapse-4" class="collapse" aria-labelledby="faq__heading-4" data-parent="#faq__accordion">
              <div class="card-body">
                Нет. Это не современно, сильно снижает полезный вес торта ( мастику обычно выкидывают, а это ¼ веса торта). Вместо этого могу покрыть торт кремом и поставить съедобные пряники. <a href="../gallery/gallery__cakes.html">См фото работ</a>
              </div>
            </div>
          </div>
          <!--5-->
