        ...
        <div class="d-none d-lg-block w-100">
            <ul class="navbar-nav w-100">
                ...
                <li class="nav-item col-auto p-0">
                    <a href="{{route('main')}}" class="btn btn-primary p-0 w-100" data-toggle="tooltip" data-placement="bottom" title="Главная страница">
                        <i class="fas fa-home fa-2x"></i>
                    </a>
                </li>

                <li class="nav-item col p-0">
                    <a href="{{ route('showcase.stuffing') }}" class="btn btn-primary p-0 w-100">
                ...
                <li class="nav-item col p-0">
                    <a href="{{ route('gallery.cakes') }}" class="btn btn-primary p-0 w-100">
        ...
        <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
            <ul class="navbar-nav w-100">
                ...
                <li class="nav-item col-lg p-0">
                    <a href="{{ route('gallery.deserts') }}" class="btn btn-primary p-0 w-100 text-left text-lg-center">
                ...
                <li class="nav-item col-lg p-0">
                    <a href="{{ route('showcase.deserts') }}" class="btn btn-primary p-0 w-100 text-left text-lg-center">
