        ...
        <div class="accordion" id="faq__accordion">
            ...
            <div class="product-review">
                <div class="card-header" id="faq__heading-1">
                    <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#faq__collapse-1"
                ...
                <div class="card-header" id="faq__heading-2">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-2" aria-expanded="false" aria-controls="faq__collapse-2">
            ...
            <div class="product-review">
                <div class="card-header" id="faq__heading-3">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-3" aria-expanded="false" aria-controls="faq__collapse-3">
            ...
            <div class="product-review">
                <div class="card-header" id="faq__heading-4">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-4" aria-expanded="false" aria-controls="faq__collapse-4">
                ...
                <div id="faq__collapse-4" class="collapse" aria-labelledby="faq__heading-4"
                    ...
                    <div class="card-body">
                        ...
                        веса торта). Вместо этого могу покрыть торт кремом и поставить съедобные пряники. <a
                                href="{{ route('gallery.cakes') }}">См фото работ</a>
                    </div>
                </div>
            </div>
            <!--5-->
            <div class="product-review">
                <div class="card-header" id="faq__heading-5">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-5" aria-expanded="false" aria-controls="faq__collapse-5">
            ...
            <div class="product-review">
                <div class="card-header" id="faq__heading-6">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-6" aria-expanded="false" aria-controls="faq__collapse-6">
                ...
                <div id="faq__collapse-6" class="collapse" aria-labelledby="faq__heading-6"
                     data-parent="#faq__accordion">
                    <div class="card-body">
                        Перевозить лучше всего на ровном полу автомобиля. В жару обязательно включайте кондиционер. Чем
            ...
            <div class="product-review">
                <div class="card-header" id="faq__heading-7">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-7" aria-expanded="false" aria-controls="faq__collapse-7">
                ...
                <div id="faq__collapse-7" class="collapse" aria-labelledby="faq__heading-7"
                    ...
                    <div class="card-body">
                        ...
                        заменить. Есть возможность использовать перепелиные яйца. При заказе указывайте необходимость.
                    </div>
                </div>
            </div>
            <!--8-->
            <div class="product-review">
                <div class="card-header" id="faq__heading-8">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                data-target="#faq__collapse-8" aria-expanded="false" aria-controls="faq__collapse-8">
